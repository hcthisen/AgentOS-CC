...
print_banner() {
  ...
  echo "  4. Once authenticated, set up Telegram plugin:"
  echo "     /install telegram@claude-plugins-official"
  echo "  5. Configure with your bot token when prompted"
  echo "  6. Type 'exit' to return to root, then 'exit' again to close SSH"
